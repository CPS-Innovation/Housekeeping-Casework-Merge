...
app.use('/static', express.static(path.join(__dirname, 'pdf-component', 'build', 'static')))
...
if (useDocumentation) {
  ...
  documentationApp.locals.serviceName = 'Case material and communications prototype'
